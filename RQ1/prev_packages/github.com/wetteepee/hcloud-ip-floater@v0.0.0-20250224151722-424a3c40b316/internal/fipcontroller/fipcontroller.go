...
import (
	...
	"github.com/wetteepee/hcloud-ip-floater/internal/config"
	"github.com/wetteepee/hcloud-ip-floater/internal/stringset"
)
...
func (fc *Controller) attachFIPToNode(fip *hcloud.FloatingIP, node string) error {
	...
	// extra safety for https://github.com/wetteepee/hcloud-ip-floater/issues/8
	if server == nil {
