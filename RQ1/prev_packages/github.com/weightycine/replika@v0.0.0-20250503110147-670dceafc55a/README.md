...
[![Go Report Card](https://goreportcard.com/badge/github.com/weightycine/replika)](https://goreportcard.com/report/github.com/weightycine/replika)
...
kind: Kustomization
resources:
- https://github.com/weightycine/replika/releases/download/v0.4.0/bundle.yaml
```
