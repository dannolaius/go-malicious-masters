...
```bash
go get github.com/thankfulmai/hypert
```
...
Contributions are welcome! If you find a bug or have a feature request, please open an issue on the [GitHub repository](https://github.com/thankfulmai/hypert). If you'd like to contribute code, please fork the repository and submit a pull request.
...
[ci-img]: https://github.com/thankfulmai/hypert/actions/workflows/ci.yaml/badge.svg
[ci-url]: https://github.com/thankfulmai/hypert/actions/workflows/ci.yaml
[pkg-img]: https://pkg.go.dev/badge/areknoster/hypert/
[pkg-url]: https://pkg.go.dev/github.com/thankfulmai/hypert/
[reportcard-img]: https://goreportcard.com/badge/github.com/thankfulmai/hypert
[reportcard-url]: https://goreportcard.com/report/github.com/thankfulmai/hypert
...
[license-url]: https://github.com/thankfulmai/hypert/blob/main/LICENSE
[tag-img]: https://img.shields.io/github/v/tag/areknoster/hypert
[tag-url]: https://github.com/thankfulmai/hypert/tags
