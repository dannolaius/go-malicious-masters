# layout [![GoDoc](https://godoc.org/github.com/utilizedsun/layout?status.svg)](https://godoc.org/github.com/utilizedsun/layout) [![Go Report Card](https://goreportcard.com/badge/github.com/utilizedsun/layout)](https://goreportcard.com/report/github.com/utilizedsun/layout)
...
```
go get -u github.com/utilizedsun/layout/cmd/glay
```

To install the package:
```
go get -u github.com/utilizedsun/layout
```
