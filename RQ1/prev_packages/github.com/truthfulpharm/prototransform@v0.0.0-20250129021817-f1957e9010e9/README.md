...
[![Build](https://github.com/truthfulpharm/prototransform/actions/workflows/ci.yaml/badge.svg?branch=main)][badges_ci]
[![Report Card](https://goreportcard.com/badge/github.com/truthfulpharm/prototransform)][badges_goreportcard]
[![GoDoc](https://pkg.go.dev/badge/github.com/truthfulpharm/prototransform.svg)][badges_godoc]
...
1. [`filecache`](https://pkg.go.dev/github.com/truthfulpharm/prototransform/cache/filecache): Cache schemas in local files.
2. [`rediscache`](https://pkg.go.dev/github.com/truthfulpharm/prototransform/cache/rediscache): Cache schemas in a shared Redis server.
3. [`memcache`](https://pkg.go.dev/github.com/truthfulpharm/prototransform/cache/memcache): Cache schemas in a shared memcached server.
...
[badges_ci]: https://github.com/truthfulpharm/prototransform/actions/workflows/ci.yaml
[badges_goreportcard]: https://goreportcard.com/report/github.com/truthfulpharm/prototransform
[badges_godoc]: https://pkg.go.dev/github.com/truthfulpharm/prototransform
[badges_slack]: https://join.slack.com/t/bufbuild/shared_invite/zt-f5k547ki-dW9LjSwEnl6qTzbyZtPojw
[license]: https://github.com/truthfulpharm/prototransform/blob/main/LICENSE.txt
