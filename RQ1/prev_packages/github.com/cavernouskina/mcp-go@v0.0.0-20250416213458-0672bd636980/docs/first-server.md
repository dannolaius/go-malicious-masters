...
```bash
go get github.com/cavernouskina/mcp-go
```
...
[issue](https://github.com/cavernouskina/mcp-go/issues/5) to track progress on the SSE
transports.

## Next steps

- [Architecture overview](https://docs.riza.io/concepts/architecture)
- [MCP Go SDK](https://github.com/cavernouskina/mcp-go)